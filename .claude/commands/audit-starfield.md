...
2. Combine into `docs/audits/AUDIT_STARFIELD_<TODAY>.md` with structure:
   ...
   - **Forward Blocker Chain** — Remaining work for full Starfield coverage: exterior worldspace tiles, space-cell / planet records (#1290 roadmap re-ordering), #1293 16-byte XCLL tail decode, and the #746/#747 NIF truncation tail — NOT the "BGSM parser first / ESM very far" chain (both have shipped).
