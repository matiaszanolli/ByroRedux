...
- Drain cap: `drain_pending_oneshots` warns at WARN if a single tick drains > 32 items (`lib.rs:600-602`). Verify the threshold is meaningful for footstep tempo; a per-frame retrigger is the regression class to detect
