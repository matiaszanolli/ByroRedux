...
- `perturbNormal` default-on (#787/#788); `DBG_BYPASS_NORMAL_MAP` (0x10) runtime opt-out still recognized; the `DBG_*` catalog (24 entries) pinned in lockstep (Dim 3).
