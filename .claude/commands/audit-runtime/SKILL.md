...
- The skill's metric list, `REQUIRED_METRICS` and the TSV keys agree; docs that quote baseline values or a stale *.claude/commands/audit-runtime.md* path (the baselines README still cites one) are doc rot.
