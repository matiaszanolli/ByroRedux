===== 3931 =====
OPEN | bug nif-parser medium legacy-compat nif game:starfield 
...
===== 3932 =====
OPEN | documentation low legacy-compat game:starfield doc-rot 
...
===== 3938 =====
OPEN | bug medium performance scripting 
...
===== 3939 =====
OPEN | bug medium scripting quests 
# SCR-D5-2026-09-06-03: lowering accepts provider barriers against a catalog the dispatcher may be unable to serve — `PapyrusProviderRuntime::default()` pairs a non-empty `engine_compatibility()` catalog with `callback: None`, a tolerated startup er...
