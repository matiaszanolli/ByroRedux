===== ISSUE 3923 =====
SK-2026-09-05-D4-01: the GMST leveling overlay is structurally unreachable, and the real-data test pins that as expected
STATE: OPEN
LABELS: bug medium legacy-compat game:skyrim character 
...
===== ISSUE 3924 =====
SK-2026-09-05-D5-01: the runtime archive chain has no present-only optional tier, so AE / Creation Club archives are unreachable
STATE: OPEN
LABELS: bug import-pipeline low legacy-compat game:skyrim 
...
STATE: OPEN
LABELS: bug nif-parser critical legacy-compat nif game:oblivion 
...
STATE: OPEN
LABELS: bug nif-parser medium legacy-compat nif game:oblivion 
