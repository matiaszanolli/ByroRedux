# NIFAL-D7-03: operation->FloatTarget and target_color->ColorTarget discriminator tables duplicated between KF and embedded animation arms
...
GitHub issue #2304, labels: low, animation, tech-debt, bug.
