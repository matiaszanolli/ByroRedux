title:	NIFAL-D9-03: translation_completeness.rs fill-rate floors have ~33pp slack; metO/rghO/normal_map columns have no assertion at all
state:	OPEN
author:	matiaszanolli (Matias Zanolli)
labels:	bug, low, nif-parser, tech-debt
comments:	0
assignees:	
projects:	
milestone:	
