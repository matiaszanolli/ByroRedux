...
| Fallout 4 Scaleform host objects | ◐ `BGSCodeObj` lifecycle + 129-method reconstructed-source catalog + injected ABC dispatch + BA2-backed `ImportAssets` shipped; installed HUD reaches frame 1, broader lifecycle/inventory pending M48 |
