...
3. Follow the canonical command's unsafe census, dimension order (skip dimensions whose Paths have no commits since the last report), regression guards, evidence rules, deduplication, and report format.
