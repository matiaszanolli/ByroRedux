...
**Last verified**: 2026-09-18 (mid-session ground-truth pass at HEAD
`774560dce` — tests **8190, 0 failing**, +24 vs the 2026-09-17 close's
8166; Rust `src/` LOC **~606 503**, +9 305; total `.rs` LOC **~643 958**,
+2 928; source files **1126** (1043 outside `tests/`), +4/+4; workspace
members unchanged at **33**; open issue dirs **4382**, +1). Session 86 split `VulkanContext` into five cohesive
...
Ground-truth as of 2026-09-18 (HEAD `774560dce`). Every figure in this
table was measured at that HEAD, not carried forward.

| Metric                                  | Value                        |
|-----------------------------------------|------------------------------|
| Rust source lines (`src/` dirs)         | ~606 503                      |
