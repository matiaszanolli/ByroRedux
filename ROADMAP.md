...
closed**: this was backlog drainage, not milestone churn. Bench-of-record
(`28155b79`, 2026-08-04) is now 186 commits stale — a **fourth** consecutive
fold of R6a-stale-19, and this session again touched shading code
(`triangle.frag`, `cluster_cull.comp`, `volumetrics_inject.comp`, `pbr.glsl`),
so its "unreliable, not merely stale" verdict stands. CI has also been red on
