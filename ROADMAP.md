...
| Tests                                   | **5602 passing, 0 failing, 159 ignored** (`cargo test --workspace`, 2026-08-20). Clean full-workspace run, including doc-tests. |
