...
**Last verified**: 2026-05-24 (Session 42 — R6a-stale-12 closeout. 113 commits past `d0b52bd5`. **Biggest perf bump in months**: #1195/#1196/#1197 skin-chain dirty gates + #1259 blend-pipeline fast path + #1260 off-frustum flag-assembly skip collectively deliver +33–50% across all three benchmarks; see [HISTORY.md](HISTORY.md)).
...
Ground-truth as of 2026-05-23, verified by `/session-close`.

| Metric                                  | Value                        |
|-----------------------------------------|------------------------------|
| Rust source lines (non-test)            | ~192 906                     |
| Rust total lines                        | ~204 480                     |
| Source files (non-test)                 | 484                          |
| Workspace members                       | 20                           |
| Tests (last reported by ROADMAP)        | 2457 (Session 40 2310 + Session 41 +147: M30.2 stmt+script parser tests (+22), M47.0 phase 1-6 wiring + e2e tests (+18), M47.1 condition.rs parser + evaluator + OR-precedence regression pins (+20), M27 declared-access regression pins, M28.5 KCC controller tests, M40 P2 cell-swap orchestrator tests, NIF/BSA 13-issue bug-bash regression coverage (#1148/#1179/#1180/#1182/#1184/#1186/#1201/#1202/#1203/#1204/#1205/#1206/#1207/#1208/#1209/#1225), renderer perf-instrumentation coverage from #1194 follow-up + #1195/#1196/#1197). |
| Open issue directories                  | 1179 (`.claude/issues/`)     |
