...
mod tests {
    ...
    fn generated_header_contains_all_defines() {
        ...
        for (name, expected) in [
            ...
            ("CLOUD_VIEW_STEPS", format!("#define CLOUD_VIEW_STEPS {CLOUD_VIEW_STEPS}")),
            ...
            ("COMBUSTION_SOOT_SINGLE_SCATTER_ALBEDO", format!("#define COMBUSTION_SOOT_SINGLE_SCATTER_ALBEDO {COMBUSTION_SOOT_SINGLE_SCATTER_ALBEDO:?}")),
