...
/// (`build_blas_batched`'s per-mesh size-query and per-mesh record — the
/// never-called single-shot `build_blas` this docstring used to also name
/// was deleted by #2914). Vulkan spec
