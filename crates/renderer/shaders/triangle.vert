...
layout(set = 1, binding = 1) uniform CameraUBO {
    ...
    vec4 sunDirection;   // xyz = sun direction, w = intensity. #1210 (water.frag consumer; declared here for struct-sync).
};
