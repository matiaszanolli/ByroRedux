...
// #2599's cross-copy pin (`facegen_half_to_f32_copy_matches_canonical_
// bit_for_bit`) was removed with the facegen copy itself: #4653 showed
// the EGM "half-float" decode was a mis-typing (the format stores
// scaled int16s), so facegen no longer decodes half-floats at all.
