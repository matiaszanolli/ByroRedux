//! `spt_tail` — post-`tail_offset` structure analyzer (EX-14/15 Phase 2.1).
//!
//! **Finding (2026-09-07, #3808): there is no geometry tail.** This tool
//! is what showed the region past `tail_offset` is the same parameter TLV
//! stream, beyond `TAG_MAX`, and that `19985`/`19989` are mis-conversions
//! of `0x4E21`/`0x4E25` appearing in 0 of 159 files. See
//! `crates/spt/docs/format-notes.md`, 2026-09-07. The question below is
//! kept as the one it was written to answer.
//!
...
fn report(
    ...
    println!("# `.spt` post-`tail_offset` structure scan\n");
    println!(
