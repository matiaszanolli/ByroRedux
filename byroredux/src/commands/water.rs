...
impl ConsoleCommand for WaterDumpCommand {
    ...
    fn execute(&self, world: &World, _args: &str) -> CommandOutput {
        ...
        for (entity, plane, volume, flow, contains_camera, lod_render_only) in rows {
            ...
            lines.push(format!(
                "    underwater_fog={:.1}..{:.1} depth_weights=[{:.3},{:.3},{:.3},{:.3}] effects=[{:.3},{:.3},{:.3},{:.3}] extinction_coefficients=[{:.5},{:.5},{:.5}] opacity={:.3} shoreline={:.1} flowmap_scale={:.3} rain_response={:.3}",
                ...
                material.absorption_coefficients[0],
                material.absorption_coefficients[1],
                material.absorption_coefficients[2],
                material.opacity,
