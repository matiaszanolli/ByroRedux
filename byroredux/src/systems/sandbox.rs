...
//! furniture. **Live by default since M42.10** (kill-switch:
//! `BYRO_NO_AI_LOCOMOTION=1`; registered from
//! `boot/schedule/post_update.rs`), the seat placement + clip-swap
//! pipeline having been verified live on FNV/FO3 content (see the M42.1
//! mechanism below for the one cross-game caveat that remains).
//!
