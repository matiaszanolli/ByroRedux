...
streaming RIS shadows, 251.6 FPS / 3.97 ms on RTX 4070 Ti (commit bee6d48,
`--bench-frames 300`).*
...
| **Tests passing** | 900+ across 16 workspace crates |
| **Source code** | ~91 K lines of Rust across 197 source files |
